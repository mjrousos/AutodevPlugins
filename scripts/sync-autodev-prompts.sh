...
# the part the factory replaces with code. All of them ship in the autodev plugin.
SOURCE_FILES=(
...
generated="$WORK_DIR/prompts.generated.mjs"
{
  ...
  echo "//"
  echo "// Each entry is the body of a canonical '.agent.md' from the autodev plugin,"
