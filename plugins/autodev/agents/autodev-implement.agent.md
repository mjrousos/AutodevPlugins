...
| Stage | `agent_type` |
| --- | --- |
| Tasking | `autodev:autodev-tasking` |
| Implementation | `autodev:autodev-implementation` |
| Code review | `autodev:autodev-code-review` |
| Code fix | `autodev:autodev-code-fix` |
| Security review | `autodev:autodev-code-security-review` |
| Privacy review | `autodev:autodev-code-privacy-review` |
...
- Each sub-agent's response comes back with a short `[autodev stage tracker]` footer
