/**
 * autodev-factory — one Agent Factory that runs the whole software-development loop.
 *
...
function parseMilestones(text) {
    ...
    // of `not-started`, `in-progress`, or `complete`." The stage tracker in the `autodev` plugin
...
/**
 * The stage tracker in the `autodev` plugin walks the todo list by these headings, and
